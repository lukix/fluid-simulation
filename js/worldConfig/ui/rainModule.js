define(['../../fluid-simulation-engine/base/WaterParticle'], function (WaterParticle) {
	return function (world) {
		...
		function rainGenerator() {
			...
			const MARGIN = 10;
			for(var i = 0; i < 1; i++) {
				drops.push(new WaterParticle(MARGIN+Math.random()*(world.width-2*MARGIN), -Math.random()*50));
			}
